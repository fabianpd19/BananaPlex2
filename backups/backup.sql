...
--
-- Name: clientes_info; Type: MATERIALIZED VIEW; Schema: public; Owner: empleado1
--
...
ALTER MATERIALIZED VIEW public.clientes_info OWNER TO empleado1;
...
--
-- Name: empresas_info; Type: MATERIALIZED VIEW; Schema: public; Owner: empleado1
--
...
ALTER MATERIALIZED VIEW public.empresas_info OWNER TO empleado1;
...
--
-- Name: productos_info; Type: MATERIALIZED VIEW; Schema: public; Owner: empleado1
--
...
ALTER MATERIALIZED VIEW public.productos_info OWNER TO empleado1;
...
--
-- Name: solicitudes_pendientes; Type: MATERIALIZED VIEW; Schema: public; Owner: empleado1
--
...
ALTER MATERIALIZED VIEW public.solicitudes_pendientes OWNER TO empleado1;
...
--
-- Name: vista_empleados; Type: MATERIALIZED VIEW; Schema: public; Owner: empleado1
--
...
ALTER MATERIALIZED VIEW public.vista_empleados OWNER TO empleado1;
...
2	CARLA	VERONICA	RAMIREZ	LOPEZ	Av. Central 456	0997654321	2222222222	2024-08-02 15:46:29.922912	2	2
1	MATEA	MARTIN	PEREZ	GOMEZ	Calle Principal 123	aaaaaaaaaa	1111111111	2024-08-02 15:46:29.922912	1	1
\.
...
1	1	PRUEBA_NOSE	MARIA	GOMEZ	GARCIA	0102030405	2024-08-02 15:46:29.90459	Av. Siempre Viva 123	1
2	2	MARIA	LUISA	SANCHEZ	RAMIREZ	0607080910	2024-08-02 15:46:29.90459	Calle Falsa 456	2
3	6	EJEMPL	EJEMPL	EJEMPL	EJEMPL	2300284342	2024-08-02 11:31:31	POR AHÍ	17
\.
...
1	2	4	12	1111.00	aprobado	venta	2024-08-02 16:34:08.386008	1
2	2	5	1111	1111.00	rechazado	compra	2024-08-02 16:35:00.981818	1
3	2	3	123	3.00	aprobado	venta	2024-08-02 16:35:39.933818	1
\.
...
11	2	1	4	12	13332.00	2024-08-02 16:34:23.203496	venta
12	2	1	3	123	369.00	2024-08-02 16:35:46.962893	venta
\.
...
6	cualquiera	ejemplo@example.com	$2y$10$od/OlEEzPS7lGbDj3qYWauwrH3yG2EJbDZf5lCJ9w7TKm93CsXUVe	1
\.
...
SELECT pg_catalog.setval('public.solicitudes_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.transacciones_id_seq', 12, true);
...
--
-- Name: clientes_info; Type: MATERIALIZED VIEW DATA; Schema: public; Owner: empleado1
--
...
--
-- Name: empresas_info; Type: MATERIALIZED VIEW DATA; Schema: public; Owner: empleado1
--
...
--
-- Name: productos_info; Type: MATERIALIZED VIEW DATA; Schema: public; Owner: empleado1
--
...
--
-- Name: solicitudes_pendientes; Type: MATERIALIZED VIEW DATA; Schema: public; Owner: empleado1
--
...
--
-- Name: vista_empleados; Type: MATERIALIZED VIEW DATA; Schema: public; Owner: empleado1
--
